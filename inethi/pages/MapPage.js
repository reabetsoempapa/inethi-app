...
MapboxGL.setAccessToken(
  'sk.eyJ1IjoicG1hbWJhbWJvIiwiYSI6ImNseG56djZwdDA4cGoycnM2MjN2ZWxoNXIifQ.DVX2kNaurf_IJFPlZYE0zw',
);
            ...
            if (internetCheck.ok) {
              ...
              const formattedData = await Promise.all(
                data.map(async (item, index) => {
                  const status = (await pingNode(item.ip))
                    ? 'online'
                    : 'offline';
                  return {
                    id: index,
    ...
    pinLocation && (
      <MapboxGL.PointAnnotation
        ...
        <View style={styles.pinnedMarker}>
          <Image
            source={{
              uri: 'https://img.icons8.com/ios-filled/50/000000/standing-man.png',
            }}
  ...
  return (
    <View style={styles.container}>
      ...
      <MapboxGL.MapView
        ...
        scrollEnabled={true}
        styleURL={
          isOffline ? MapboxGL.StyleURL.Street : MapboxGL.StyleURL.Outdoors
        }
        onMapIdle={onMapIdle}
